...
from jasentool.cdm.io.delimited import read_delimited, validate_fields
from jasentool.cdm.io.types import DelimiterRow, StreamOrPath
from jasentool.cdm.core.envelope import (
    default_empty_predicate,
    envelope_absent,
    envelope_skipped,
    run_as_envelope,
)
from jasentool.cdm.exceptions import UnsupportedAnalysisTypeError
from jasentool.cdm.models.enums import AnalysisType, ResultStatus
...
class BaseParser(ABC):
    ...
    def __init__(self, *, logger: Logger | None = None):
        self.logger = logger or getLogger(f"jasentool.cdm.{self.parser_name}")
    ...
    def _new_output(self, software_version: str | None) -> "ParserOutput":
        ...
        from jasentool.cdm.models.base import ParserOutput
